...
# You only need to change code with docs strings that have TO DO.
...
class Graph(object):
    ...
    def dfs_helper(self, start_node):
        ...
        for edge in start_node.edges:
            if edge.node_to.value == start_node.value:
                next_node = self.dfs_helper(edge.node_from)
            elif edge.node_from.value == start_node.value:
                next_node = self.dfs_helper(edge.node_to)
            if next_node:
                ret_list += next_node
        # Your code here
        return ret_list
    ...
    def bfs(self, start_node_num):
        ...
        ret_list = [node.value]
        # Your code here
        ret_list = self.bfs_helper(node, ret_list)
        return ret_list

    def bfs_helper(self, start_node, ret_list):
        queue = []
