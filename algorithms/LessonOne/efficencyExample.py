...
'''
Check your answer to Example 1. It's not quite 'O(2n)' - remember to approximate if you can.

Check your answer to Example 2. You don't need to include m or n, since Example 2 doesn't include iterating over anything.

Check your answer to Example 3. Since there is a for loop that iterates over the list of manatee properties, you'll probably need m in your efficiency!

Check your answer to Example 4. It's not quite 'O(4(3n)+2)' - remember to approximate if you can.
'''
...
'''O(1)
    this doesn't use m or n because it doesn't iterate
    because aproximation, you should reduce any numbers that you multiply by to 1, and anything you add by to 0
    Explanation:
